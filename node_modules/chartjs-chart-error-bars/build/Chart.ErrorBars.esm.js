import { defaults as defaults$5, elements, helpers, controllers, scaleService } from 'chart.js';
...
defaults$5.global.elements.rectangleWithErrorBar = _objectSpread2({}, defaults$5.global.elements.rectangle, {}, defaults);
var RectangleWithErrorBar = elements.RectangleWithErrorBar = elements.Rectangle.extend({
  transition: function transition(ease) {
    var startBak = transitionErrorBarHelper(this._start);
    var r = elements.Rectangle.prototype.transition.call(this, ease);
  ...
  draw: function draw() {
    elements.Rectangle.prototype.draw.call(this);
    renderErrorBar(this._view, this._chart.ctx);
  }
});

defaults$5.global.elements.pointWithErrorBar = _objectSpread2({}, defaults$5.global.elements.point, {}, defaults);
var PointWithErrorBar = elements.PointWithErrorBar = elements.Point.extend({
  transition: function transition(ease) {
    var startBak = transitionErrorBarHelper(this._start);
    var r = elements.Point.prototype.transition.call(this, ease);
    var model = this._model;
    var start = this._start;
    var view = this._view; // No animation -> No Transition
  ...
  draw: function draw() {
    elements.Point.prototype.draw.call(this);
    renderErrorBar(this._view, this._chart.ctx);
  }
});

defaults$5.global.elements.arcWithErrorBar = _objectSpread2({}, defaults$5.global.elements.arc, {}, defaults);
var ArcWithErrorBar = elements.ArcWithErrorBar = elements.Arc.extend({
  transition: function transition(ease) {
    var startBak = transitionErrorBarHelper(this._start);
    var r = elements.Arc.prototype.transition.call(this, ease);
    var model = this._model;
    var start = this._start;
    var view = this._view; // No animation -> No Transition
  ...
  draw: function draw() {
    elements.Arc.prototype.draw.call(this);
...
function generateTooltip(horizontal) {
  ...
  return function (item, data) {
    var base = defaults$5.global.tooltips.callbacks.label.call(_this, item, data);
...
function generateTooltipPolar(item, data) {
  var base = defaults$5.polarArea.tooltips.callbacks.label.call(this, item, data);
  var v = data.datasets[item.datasetIndex].data[item.index];
...
var barWithErrorBars = {
  dataElementType: elements.RectangleWithErrorBar,
...
var BarWithErrorBars = controllers.barWithErrorBars = controllers.bar.extend(barWithErrorBars);
var HorizontalBarWithErrorBars = controllers.horizontalBarWithErrorBars = controllers.horizontalBar.extend(barWithErrorBars);
...
var lineWithErrorBars = {
  dataElementType: elements.PointWithErrorBar,
  _elementOptions: function _elementOptions() {
...
var LineWithErrorBars = controllers.lineWithErrorBars = controllers.line.extend(lineWithErrorBars);
...
var polarAreaWithErrorBars = {
  dataElementType: elements.ArcWithErrorBar,
  _elementOptions: function _elementOptions() {
...
var PolarAreaWithErrorBars = controllers.polarAreaWithErrorBars = controllers.polarArea.extend(polarAreaWithErrorBars);

var linearWithErrorBarsOptions = helpers.merge({}, [scaleService.getScaleDefaults('linear')]);
var LinearWithErrorBarsScale = scaleService.getScaleConstructor('linear').extend({
...
scaleService.registerScaleType('linearWithErrorBars', LinearWithErrorBarsScale, linearWithErrorBarsOptions);

var logarithmicWithErrorBarsOptions = helpers.merge({}, [scaleService.getScaleDefaults('logarithmic')]);
var LogarithmicWithErrorBarsScale = scaleService.getScaleConstructor('logarithmic').extend({
  determineDataLimits: function determineDataLimits() {
    var _this = this;
...
scaleService.registerScaleType('logarithmicWithErrorBars', LogarithmicWithErrorBarsScale, logarithmicWithErrorBarsOptions);

var radialLinearWithErrorBarsOptions = helpers.merge({}, [scaleService.getScaleDefaults('radialLinear')]);
var RadialLinearWithErrorBarsScale = scaleService.getScaleConstructor('radialLinear').extend({
  determineDataLimits: function determineDataLimits() {
    commonDataLimits.call(this, false, null, true);
    this.handleTickRangeOptions();
  }
});
scaleService.registerScaleType('radialLinearWithErrorBars', RadialLinearWithErrorBarsScale, radialLinearWithErrorBarsOptions);

export { ArcWithErrorBar, BarWithErrorBars, HorizontalBarWithErrorBars, LineWithErrorBars, LinearWithErrorBarsScale, LogarithmicWithErrorBarsScale, PointWithErrorBar, PolarAreaWithErrorBars, RadialLinearWithErrorBarsScale, RectangleWithErrorBar, ScatterithErrorBars };
